...
export const Route = createFileRoute("/admin/qr")({
  ...
  head: () => ({ meta: [{ title: "QR Codes — King Water Admin" }, { name: "robots", content: "noindex" }] }),
});
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                  This is the web address customers will be directed to when they scan the QR code. Make sure it points to the public Water Quality Report page.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-slate-100">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <span className="flex items-center gap-2"><Download size={18} /> Download as PNG (Image)</span>
                    <span className="text-[10px] font-normal uppercase tracking-wider px-2 py-1 bg-slate-100 rounded text-slate-600">Best for web/social</span>
                  </button>
                  <button 
                    onClick={downloadSVG}
                  ...
                  >
                    <span className="flex items-center gap-2"><Printer size={18} /> Download as SVG (Vector)</span>
                    <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 bg-white/20 rounded text-white">Best for printing</span>
                  </button>
                </div>
              </div>
              
              <div className="rounded-md bg-amber-50 p-4 border border-amber-100 mt-2">
                <h5 className="text-xs font-bold text-amber-800 uppercase tracking-wider mb-1">Printing Guidelines</h5>
                <ul className="text-xs text-amber-900/80 space-y-1 list-disc pl-4">
                  <li>Always download the <strong>SVG vector format</strong> when sending to your packaging printer.</li>
